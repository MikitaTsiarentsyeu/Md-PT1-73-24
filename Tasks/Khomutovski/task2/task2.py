...
print(f'ваше время: {user_time}')

if ':' not in user_time or len(user_time) != 5:
...
if minute == 0:
    if hour == 1:
        print(f'{dict_hour.get(hour)[0]} час')
    elif hour == 2 or hour == 3 or hour == 4:
        print(f'{dict_hour.get(hour)[0]} часа')
    else:
        print(f'{dict_hour.get(hour)[0]} часов')
